...
var parse_config_1 = require("../config/parse.config");
var compiler;
var devserver = parse_config_1.getDevServer();
try {
...
if (!!devserver.proxy && Object.keys(devserver.proxy).length > 0) {
    var arrayProxy = Object.entries(devserver.proxy);
...
app.get('*', function (req, res, next) {
    var _a;
    var filename = path_1.default.join((_a = webpack_config_1.default.output) === null || _a === void 0 ? void 0 : _a.path, 'index.html');
...
//监听端口，并打开浏览器
app.listen(devserver.port, function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, open_1.default("http://127.0.0.1:" + devserver.port)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
